                            ...
                            <div class="col-12">
                                ...
                                <div>
                                    <md-table  v-model="Tab" md-sort="region" md-sort-order="asc" md-card>
                                        <md-table-toolbar>
                                            <h1 class="md-title">Tableau des client servie par ticket a distance </h1>
                                        </md-table-toolbar>
                                        <md-table-row slot="md-table-row" slot-scope="{ item }">
                                            ...
                                            <md-table-cell md-label="Nom du client" md-sort-by="cname">{{ item.cname }}</md-table-cell>
...
export default {
    ...
    methods: {
        ...
        async loadData(){
            this.Loading = true
            await axios.get('http://localhost:3000/Api/Dashboard/fullTab')
            .then((res) => {
